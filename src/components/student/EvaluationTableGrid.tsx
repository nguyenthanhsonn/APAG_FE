    ...
    <div className="flex items-center gap-2">
      <div className="flex items-center">
        <button
          ...
          className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-l text-gray-500 hover:bg-gray-100 disabled:opacity-40 disabled:hover:bg-transparent cursor-pointer disabled:cursor-not-allowed"
        >
          <Minus size={11} />
        </button>
        <input
          ...
          disabled={disabled}
          className={`w-11 h-8 text-center text-sm border-y font-bold disabled:bg-gray-100 outline-none transition-colors ${
            isInvalidInput
        ...
        <button
          ...
          className="w-8 h-8 flex items-center justify-center border border-gray-300 rounded-r text-gray-500 hover:bg-gray-100 disabled:opacity-40 disabled:hover:bg-transparent cursor-pointer disabled:cursor-not-allowed"
        >
          <Plus size={11} />
        </button>
      </div>
...
export const EvaluationTableGrid = () => {
  ...
  // Sec 5
  const svRoleType = useEvaluationFormStore(s => s.svRoleType || 'student');
  ...
  const classRoleType = useEvaluationFormStore(s => s.classRoleType || 'student');
        ...
        <table className="w-full border-collapse text-sm">
          ...
          <tbody>
            ...
            <tr className="bg-gray-50 border-b border-gray-300">
              <td className={`${tdR} text-center font-semibold text-gray-500`}>1</td>
              <td className={`${tdR} text-gray-700 font-semibold`} colSpan={2}>
                Chọn đối tượng đánh giá Mục V:
                <div className="text-xs text-gray-400 font-normal">Hệ thống sẽ hiển thị nội dung đánh giá của nhánh được chọn.</div>
              </td>
              <td className={`${tdR} font-bold text-gray-600 text-center`}>10.00</td>
              <td className={tdR} colSpan={2}>
                <div className="flex flex-col gap-2">
                  {[
                    ...
                    <label key={opt.v} className="flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-gray-700 cursor-pointer">
                      <input
                        type="radio"
                        name="sv_role_grid"
                        value={opt.v}
                  ...
                  {isSvViolationSec5 ? <LockedScore /> : (
                    <>
                      <ScoreSelect
                        ...
                        disabled={!isSvEditable || !isSvOfficer || isSvViolationSec5}
                      />
                      <FieldError name="svCadrePerformance" />
                    </>
                  )}
                </td>
                  ...
                  {isSvViolationSec5 ? <LockedScore /> : (
                    <>
                      <ScoreSelect
                        ...
                        disabled={!isSvEditable || !isSvOfficer || isSvViolationSec5}
                      />
                      <FieldError name="svManagementLevel" />
                    </>
                  )}
                </td>
                  ...
                  {isSvViolationSec5 ? <LockedScore /> : (
                    <>
                      <select
                        ...
                        className="w-20 h-10 px-2 text-center text-sm border border-gray-300 rounded-md bg-white font-bold outline-none focus:ring-1 focus:ring-blue-400 disabled:bg-gray-100 cursor-pointer shadow-sm"
                      >
                      ...
                      <FieldError name="svClassParticipation" />
                    </>
                  )}
                </td>
                ...
                <td className={tdBase}>
                  {isClassViolationSec5 ? <LockedScore /> : (
                    <select
                      ...
                      className="w-20 h-10 px-2 text-center text-sm border border-gray-300 rounded-md bg-white font-bold outline-none focus:ring-1 focus:ring-indigo-400 disabled:bg-gray-100 cursor-pointer shadow-sm"
                    >
                      <option value={0}>0.00 đ</option>
                      <option value={1}>1.00 đ</option>
                      <option value={2}>2.00 đ</option>
                  ...
                  {isSvViolationSec5 ? <LockedScore /> : (
                    <>
                      <ScoreSelect
                        ...
                        disabled={!isSvEditable || !isSvStudent || isSvViolationSec5}
                      />
                      <FieldError name="svSpecialAchievement" />
                    </>
                  )}
                </td>
