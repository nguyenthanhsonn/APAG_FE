          ...
          <div className="flex h-full items-center justify-between gap-4 px-4 sm:px-6">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden sm:flex flex-col items-end text-right">
                <span className="text-sm font-semibold text-gray-900">Phòng Đào tạo</span>
                <span className="text-xs text-gray-500 font-medium">Chỉ xem báo cáo</span>
              </div>
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#104E92] text-xs font-bold text-white shadow-sm">
                PĐT
              </div>
            </div>
          </div>
