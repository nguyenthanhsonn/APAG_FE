...
export const metadata: Metadata = {
  ...
  title: {
    default: 'APAG - Đánh giá rèn luyện sinh viên',
    template: '%s | APAG',
  },
  ...
  applicationName: 'APAG',
  keywords: ['đánh giá rèn luyện', 'quản lý sinh viên', 'APAG', 'điểm rèn luyện'],
  robots: {
    index: false,
    follow: false,
  },
  openGraph: {
    title: 'APAG - Đánh giá rèn luyện sinh viên',
